...
public final class BackgroundAudioService
	...
	//MediaMetadataRetriever _retriever;
	...
	public void Play(Track track){
		...
		//Logger.Log("android artist:"+ metaRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_ARTIST));
		//Logger.Log("android title:"+ metaRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_TITLE));
		if (_prepared) {
			_prepared = false;
			_player.stop();
			_player.reset();
		...
		//_retriever.setDataSource(track.Url);
		//_currentTrack.Name = _retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_TITLE);
		//_currentTrack.Artist = _retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_ARTIST);
	...
	public void onCompletion(MediaPlayer mp) {
		setState(AndroidPlayerState.PlaybackCompleted);
